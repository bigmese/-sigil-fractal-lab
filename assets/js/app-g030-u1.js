import { loadAtlas, atlasSummary } from "./atlas-g030-u1.js";
import { createBlueprint } from "./blueprint-g030-u1.js";
import { Diagnostics, cssIsReady } from "./diagnostics-g030-u1.js";
import { buildGeometry } from "./geometry-g030-u1.js";
import { renderSymbol, setConstructionVisible } from "./renderer-g030-u1.js";
import { exportBlueprint, exportPng, exportSvg, exporterIsReady } from "./exporter-g030-u1.js";
import { activateTab, bindTabs, buildAtlasFilters, populateIntentions, renderAtlas, renderBlueprintInspector, setSystemMessage, updateCanvasMetadata } from "./ui-g030-u1.js";
...
async function bootstrap() {
  ...
  window.SymbolDNA = Object.freeze({ release: "G0.3.0-U1", atlas: summary, regenerate: () => generate(), getBlueprint: () => state.blueprint });
}
